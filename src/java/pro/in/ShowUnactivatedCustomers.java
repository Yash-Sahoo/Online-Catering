    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(rs.next()==false){
                ...
                rs.beforeFirst();
            out.println("<html>");
            out.println("<head><title>Unverified Customers</title>");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<center><font color=white><h2>Unverified Customers</h2></font></center>");
            out.println("<hr>");
            out.println("<table border=2>");
            out.println("<tr>");
            out.println("<th width=200>E-Mail</th>");
            out.println("<th width=200>Name</th>");
            out.println("<th width=300>Address</th>");
            out.println("<th width=100>Mobile</th>");
            out.println("<th width=100>Activate</th>");
            ...
            while(rs.next()){
                ...
                out.println("<td><a title=activate href='changeCustomerStatus?id="+email+"'>activate</a></td>");
                out.println("<td><a title=block href='deleteCustomerApplied?id="+email+"'>block</a></td>");
            }
            out.println("</table>");
            out.println("<hr>");
