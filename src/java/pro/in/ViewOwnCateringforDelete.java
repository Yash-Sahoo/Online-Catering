...
public class ViewOwnCateringforDelete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            rs.beforeFirst();
            if(b==false){
                JOptionPane.showMessageDialog(null,"No Such Catering Details Found!!!");
                response.sendRedirect("ownerDashboard.jsp");
            }else{
                out.println("<html>");
                out.println("<body>");
                out.println("<h2><font face=algerian>Remove your Catering Details</font></h2>");
                out.println("<hr>");
            ...
            //        out.println("<td>"+rs.getString("email")+"</td>");
                    ...
                    out.println("<td><img height=100 width=200 src=\"imageloader?id="+rs.getString("cid")+"\"></td>");
                    out.println("<td><a href=BlockInfoByCater?id="+rs.getString("cid")+">Delete</a></td>");
                    out.println("</tr>");
                }
                out.println("</table>");
                out.println("<hr>");
