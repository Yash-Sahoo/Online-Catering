    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(rs.next()==false){
                ...
                rs.beforeFirst();
            out.println("<html>");
            out.println("<head><title>Block Caterers</title>");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<font color=white><center><h2>Block the Caterer</h2></center></font>");
            out.println("<hr>");
            out.println("<table border=2>");
            out.println("<tr>");
            out.println("<th width=240>E-Mail</th>");
            out.println("<th width=240>Name</th>");
            ...
            while(rs.next()){
                ...
                out.println("<td><a title=block href='BlockingTheOwner?id="+email+"'>block</a></td>");
            }
            out.println("</table>");
            out.println("<hr>");
