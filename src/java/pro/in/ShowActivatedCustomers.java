    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(rs.next()==false){
                ...
                rs.beforeFirst();
            out.println("<html>");
            out.println("<head><title>Verified Customers</title>");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<center><font color=white><h2>Verified Customers</h2></font></center>");
            out.println("<hr>");
            out.println("<table border=2>");
            out.println("<tr>");
            out.println("<th width=200>E-Mail</th>");
            out.println("<th width=140>Name</th>");
            out.println("<th width=360>Address</th>");
            out.println("<th width=90>Mobile</th>");
            out.println("<th width=90>Permission</th>");
            ...
            while(rs.next()){
                ...
                out.println("<td><a title=Suspend href='suspendCustomer?id="+email+"'>Suspend</a></td>");
                out.println("<td><a title=block href='deleteCustomerAppliedCopy?id="+email+"'>block</a></td>");
            }
            out.println("</table>");
            out.println("<hr>");
